...
[![License](https://img.shields.io/badge/license-CC0-blue?style=flat-square)](https://creativecommons.org/publicdomain/zero/1.0/)
...
- [The Station Directory](#the-station-directory)
    ...
    - [Global Independent & Online Communities](#global-indie-radio)
    - [Decades, Oldies & Nostalgia](#decades-oldies-nostalgia)
    - [Electronic](#electronic)
    - [Funk, Soul, Hip-Hop & Disco](#funk-soul-hiphop-disco)
    ...
    - [Christmas & Holiday](#christmas-music-holiday)
- [Experimental, Nerdy & Scanners](#experimental)
- [Multi-Station Networks](#multi-station)
- [Station Directories & Databases](#directories)
- [Finding Stream URLs](#finding-urls)
- [Music Discovery & Non-Radio Listening](#non-radio-listening)
...
## The Station Directory <a id="the-station-directory"></a>
...
- [Ambient.FM](https://ambient.fm/): One person's slowed-down electronica, stretched to 19-minute tracks, entirely human-made. [Stream](https://phoebe.streamerr.co:4140/ambient.mp3)
- [Ambinature Radio](https://www.ambinature.xyz/): Listener-supported nature sounds with no music, no beats, no ads, since 2015. [Stream](https://nature-rex.radioca.st/stream)
- [Birdsong FM](https://www.birdsong.fm/): A short birdsong recording, played on a continuous loop. [Stream](https://a1.radio.co/s5c5da6a36/listen)
- [Cafe Del Mar](https://cafedelmar.com/radio): Chillout compilations from the Ibiza sunset bar, since José Padilla's 1994 Volumen Uno. [Stream](https://streams.radio.co/se1a320b47/listen)
...
- [Mountain Chill](https://mountainchill.com): Only full-time chillout FM station in the US, run by two brothers from Telluride since 2011. [Stream](https://mountain-chill.radiocult.fm/stream)
...
- [NTS - Field Recordings](https://www.nts.live/infinite-mixtapes/field-recordings): Listener-submitted field recordings of homes, cities, and gardens worldwide. [Stream](https://stream-mixtape-geo.ntslive.net/mixtape23)
...
- [Subsonic Radio](https://www.subsonicradio.com/): Unofficial recordings from Disney theme-park attractions, resorts, and parades, across 16 channels since the mid-2000s. [SR One](https://www.subsonicradio.com:8443/requests.mp3) / [SR Two - Extended Plays](https://www.subsonicradio.com:8443/longbois.mp3) / [WEDWay PeopleMover](https://www.subsonicradio.com:8443/wedway.mp3)
...
- [Bru Zane](https://bru-zane.com/classical-radio/): Archive of French Romantic music (1780-1920) from the Palazzetto Bru Zane in Venice, since 2016. [Stream](https://uk2.streamingpulse.com/ssl/bzr)
- [Classical California](https://www.classicalcalifornia.org/): Classical from LA and San Francisco, home of SF Symphony and SF Opera broadcasts. [Stream](https://14103.live.streamtheworld.com/KUSCAAC96.aac)
- [Concertzender - Baroque](https://www.concertzender.nl/): Independent Dutch station's baroque channel, focused on lesser-known works and period performance. [Stream](http://streams.greenhost.nl:8080/barok)
...
- [France Musique - La Contemporaine](https://www.radiofrance.fr/francemusique/radio-contemporaine): Contemporary classical focusing on living composers and world premieres. [Stream](http://icecast.radiofrance.fr/francemusiquelacontemporaine-hifi.aac)
- [Linn Classical](https://www.linn.co.uk/linn-radio): High fidelity classical from Linn's audiophile catalog. [Stream](http://radio.linn.co.uk:8004/stream)
...
- [BFF.fm](https://bff.fm/): San Francisco's Mission District, 115 volunteer DJs, short for Best Frequencies Forever. [Stream](http://stream.bff.fm/1/BFF.fm.mp3)
...
- ⭐ [KFJC 89.7](https://kfjc.org): Foothill College teaching lab, experimental audio art, 8 station hours weekly to earn airtime. [Stream](http://netcast.kfjc.org/kfjc-320k-aac)
...
- ⭐ [WXYC 89.3](https://wxyc.org/): From UNC Chapel Hill, first to stream online, in 1994. [Stream](https://audio-mp3.ibiblio.org/wxyc.mp3)
- [WZRD 88.3](https://wzrdchicago.org/): Freeform from Northeastern Illinois University, students and alumni on air since 1974. [Stream](https://wzrd.streamguys1.com/live)
...
- [Do!! You!!! Radio](https://doyou.world/): Started by ex-NTS breakfast host Charlie Bones in 2021. [Stream](https://doyouworld.out.airtime.pro/doyouworld_a)
...
- [Hollow Earth Radio](https://khuh.fm/): Freeform Seattle station, one of The Wire's 100 essential stations, featuring found sound and local music. [Stream](http://centova.rockhost.com:8001/stream)
- [IDA](https://www.idaidaida.net/): Non-profit station and bar/studio split across Tallinn and Helsinki, open Thursday to Saturday nights. [Stream](https://broadcast.idaidaida.net:8000/stream)
- [Internet Public Radio](https://www.internetpublicradio.live/): Independent outlet in Guadalajara, with local and international DJs, musicians, and artists. [Stream](https://stream-relay-geo.internetpublicradio.live/stream/main)
...
- [Loose Antenna](https://looseantenna.fm/): Lausanne community radio rooted in its pirate tradition, featuring DJ sets and marginal voices. [Stream](https://stream.looseantenna.fm/radio/8000/default.mp3)
- [Loose FM](https://loose.fm/): Experimental broadcasts from a Hoxton basement, now operating from a shipping container with illuminated eyes. [Stream](https://loosefm.radiocult.fm/stream)
...
- [LYL Radio](https://lyl.live/): Auto-financed DIY broadcast from Lyon, hosting local and international shows since 2015. [Stream](https://icecast.lyl.live/live)
- [Mondo Bongo Radio](https://mondobongoradio.com): Genre-hopping, timeless music from around the world. Non-profit, Greece-based since 2011. [Stream](https://cast.mndbng.com/hls/mondobongo/aac_hifi.m3u8)
...
- [NEU Radio](https://www.neuradio.it/): Independent Bologna radio from a park studio and MAMbo museum, playing indie, electronic, jazz, and more. [Stream](https://radio.eduneu.eu:8020/radio.mp3)
...
- [Norrm](https://www.norrm.com/): Weekly shows from local and international DJs, broadcasting above their bar in Bandung since 2017. [Stream](https://listen.norrm.com/default)
- ⭐ [NTS](https://www.nts.live/): Founded in Hackney in 2011, DJs from 80+ countries, two channels, and a vast mixtape archive. ([1](http://stream-relay-geo.ntslive.net/stream), [2](http://stream-relay-geo.ntslive.net/stream2)) and [mixtapes](https://www.nts.live/infinite-mixtapes).
...
- [Radio Buena Vida](https://buenavida.co.uk/): Community radio and café-bar from Govanhill, Glasgow, covering every genre from punk to jungle. [Stream](https://s4.radio.co/s69b281ac0/listen)
...
- [Radio Dopo](https://radiodopo.it/): Community station from Palermo, launched 2025 via EU-funded partnership with Kiosk Radio and Refuge Worldwide. [Stream](https://streaming.radio.co/s807721f02/listen)
- [Radio Kapitał](https://radiokapital.pl/): Artist and activist broadcasts from Warsaw's Old Town, since 2019. [Stream](https://radiokapitalpl.out.airtime.pro/radiokapitalpl_a)
...
- [Radio Nopal](https://radionopal.com/): Live from a storefront in San Rafael, Mexico City, using open-source hardware. [Stream](https://radio.mensajito.mx/nopalA)
...
- [Radio Raheem](https://radioraheem.it/): Independent, music-focused Milan station based at the Triennale since 2017. [Stream](https://radioraheem.out.airtime.pro/radioraheem_a)
...
- [Radio Sam Sam](https://samsam.world/): World grooves, jazz beats, and psych-folk from the SAM SAM Festival in the Fontainebleau Forest. [Stream](https://listen.radioking.com/radio/742276/stream/808768)
- [Radio Santana Breda](https://radiosantana.blogspot.com/?m=0): From a 1980s FM DX hobbyist, now playing Philadelphia soul, Motown, and synth-pop. [Stream](https://server7.radio-streams.net/proxy/santana/stream)
...
- [Rukh Radio](https://rukh.live/): Non-commercial DIY community station from Odesa, Ukraine, focused on experimental and alternative music and countercultures. [Stream](https://a1.asurahosting.com/listen/rukh/radio.mp3)
...
- [STEGI.RADIO](https://stegi.radio/): Art radio from the Onassis Stegi cultural centre in Athens, with Mediterranean and global sounds. [Stream](https://movementathens.out.airtime.pro/movementathens_a)
- [Studio Néau](https://www.studioneau.be/): Free community radio in a converted shipping container in Eupen, East Belgium, since 2021. [Stream](https://studioneau.out.airtime.pro/studioneau_a)
- [Subtle Radio](https://www.subtleradio.com/): Community-led station from Hackney, London, broadcasting since 2018 to support grassroots electronic music. [Stream](https://subtle-radio-dd2656d9.radiocult.fm/stream)
...
- [Tīrkultūra](https://www.tirkultura.lv/): Experimental radio art from Riga, founded in 2015 by a fashion designer and two artists. [Stream](https://s3.radio.co/s216811754/listen)
...
- [We Are Various](https://www.wearevarious.com/): Nomadic community station from Antwerp, broadcasting live from a rotating set of local venues. [Stream](https://azuracast.wearevarious.com/listen/we_are_various/live.mp3)
...
- [Flower Power Radio](https://www.flowerpowerradio.com/): Hits from the 1950s, 60s and 70s, rock, pop, soul, Motown and disco. [Stream](http://uk1.streamingpulse.com:7000/,)
- [J-Club Bandstand](https://jclubbandstand.torontocast.stream/stations/index.html): Jazz music from the 1930s and 1940s. [Stream](https://cast1.torontocast.com:2060/stream)
...
- [Vintage Obscura Radio](https://vintageobscura.net/): Reddit-sourced rarities, pre-2000 tracks with under 30,000 YouTube views at discovery. [Stream](https://radio.vintageobscura.net/stream)
- [WALM - Classic Vinyl](https://walmradio.com/classic/): Classic rock and vinyl-based hits. [Stream](https://icecast.walmradio.com:8443/classic)
- [WALM - Old Time Radio](https://walmradio.com/otr): 1930s-50s radio dramas, comedies, and westerns, played from original 78-rpm discs. [Stream](https://icecast.walmradio.com:8443/otr)
- [Wayback Radio](https://www.waybackradio.org/): Hosted trip back to the golden age of Top 40, from Des Moines. [Stream](https://s5.citrus3.com:8244/stream)
...
- [Cafe Mambo](https://cafemamboibiza.com/): Ibiza sunset sounds from the bar Javier Anadon opened on San Antonio's coastal rocks in 1994. [Stream](http://streamer.radio.co/sd7b28e5f3/listen)
- [Centreforce](https://centreforceradio.com/): UK acid house pirate station from the late 1980s, relaunched legally on DAB in 2018. [Stream](http://centreforce.streamgb.com:8830/320)
...
- [Electro Swing Revolution](https://www.electroswing-radio.com/): Electro swing, neo swing, and swing house, run by DJ Justin Fidèle in Berlin since 2012. [Stream](https://streamer.radio.co/s2c3cc784b/listen)
...
- [NTS - 4 To The Floor](https://www.nts.live/infinite-mixtapes/4-to-the-floor): House and techno across the decades, Chicago to Detroit. [Stream](https://stream-mixtape-geo.ntslive.net/mixtape5)
- [NTS - Labyrinth](https://www.nts.live/infinite-mixtapes/labyrinth): Atmospheric breaks and tripped-out techno for getting lost in. [Stream](https://stream-mixtape-geo.ntslive.net/mixtape31)
...
- [NTS - Sweat](https://www.nts.live/infinite-mixtapes/sweat): Party music from soundsystems, block parties, and carnivals worldwide. [Stream](https://stream-mixtape-geo.ntslive.net/mixtape24)
...
- [Sanctuary Radio](https://www.sanctuaryradio.com/): Dark electro, EBM, goth, and industrial across three channels, online since 1995. [Stream](https://stream.sanctuaryradio.com/mainchannel_hq)
...
- [Sovietwave](https://sovietwave.su/): Contemporary Russian music styled after dreams from the Soviet past. [Stream](http://station.waveradio.org/soviet.mp3)
- [Space dogs](https://www.spacedogsradio.com/): Sci-fi pop, easy listening, indie, disco, and poptronika mixtapes. [Stream](https://listen2.streamaudio.co:8042/stream)
...
- [Funky Radio](https://funky.radio/): Italian-run funk from 1963-1982, vinyl-era selections and deep cuts. [Stream](https://funkyradio.streamingmedia.it/play.mp3)
- [Groove Cabane](https://www.groovecabane.com/): Festive funk, soul, and disco DJ sets from a French collective. [Stream](https://listen.radioking.com/radio/314264/stream/361499)
...
- ⭐ [La Patate Douce](https://www.lapatatedouceradio.com/): Disco-funk, Afro-soul, and house from France. [Stream](https://listen.radioking.com/radio/285742/stream/472984)
- [Le Bon Mix](https://www.lebonmix.radio/en/): Funk, disco, jazz, and soul from the Basque coast, also on FM and DAB+. [Stream](https://stream10.xdevel.com/audio13s976748-2017/stream/icecast.audio)
...
- [DR P8 Jazz](https://www.dr.dk/lyd/p8jazz): Denmark's national public jazz channel, launched in 2011 on DAB+. [Stream](http://live-icy.gss.dr.dk/A/A22H.mp3)
- [Fine Music Radio](https://www.fmr.co.za/): Classical and jazz from inside Cape Town's Artscape Theatre, since 1995. [Stream](http://edge.iono.fm/xhls/fmr_live_medium.m3u8)
...
- [JAZZ.FM91](https://www.jazz.fm): Toronto's only 24-hour jazz station, independent charity broadcasting since CJRT-FM's 1949 launch. [Stream](https://jazzfm91.streamb.live/SB00009)
...
- [Jazz Radio - Afro Jazz](https://www.jazzradio.fr/radio/webradio): African rhythms and jazz fusion, a sub-channel of France's Jazz Radio network. [Stream](https://jazz-radio-afro.ice.infomaniak.ch/jazz-radio-afro.mp3)
...
- ⭐ [Jazz24](https://www.jazz24.org/): Jazz from Seattle and Tacoma with blues, funk, and Latin jazz. [Stream](https://knkx-live-a.edge.audiocdn.com/6285_256k)
- [KCSM Jazz 91.1](https://kcsm.org/): Listener-supported jazz station from the College of San Mateo. [Stream](http://ice7.securenetsystems.net/KCSM2)
...
- [KJazz 88.1](https://kkjz.org/): America's top full-time jazz station, broadcasting from Long Beach State since 1981. [Stream](https://streaming.live365.com/a49833)
...
- [Linn Jazz](https://www.linn.co.uk/linn-radio): Audiophile jazz streams from the Linn Records catalogue. [Stream](http://radio.linn.co.uk:8000/autodj)
- [New Morning](http://www.newmorning.com/): Jazz, black music, Latin, and world music, the digital radio of a Paris jazz club. [Stream](https://listen.radioking.com/radio/605/stream/62902)
- [NTS - Expansions](https://www.nts.live/infinite-mixtapes/expansions): Spiritual and exploratory jazz, from Sun Ra to obscure Ethiopiques cuts. [Stream](https://stream-mixtape-geo.ntslive.net/mixtape3)
...
- [The Penthouse](https://thepenthouse.fm/): Crooner and vocal jazz including Sinatra and Ella alongside modern vocalists. [Stream](http://sc1.mystreamserver.com:8052/,)
...
- ⭐ [TotalRock](https://www.totalrock.com/): Classic and modern rock and metal, founded 1997 by BBC's "Voice of Metal" Tommy Vance. [Stream](https://s3.citrus3.com:8056/stream)
...
- [Badam Radio](https://badam-radio.radioweb.co/): Dub and reggae with African-influenced roots, based in France since 2017. [Stream](https://listen.radioking.com/radio/105610/stream/144949)
...
- [NTS - Island Time](https://www.nts.live/infinite-mixtapes/island-time): Reggae, dub, and rocksteady rhythms out of the Caribbean. [Stream](https://stream-mixtape-geo.ntslive.net/mixtape21)
- [Real Roots Radio](https://realrootsradio.net/): London roots and dub collective since 2009, worldwide selectors and a hand-built sound system. [Stream](https://streams.radio.co/s1df61e0af/listen)
- [SomaFM - Heavyweight Reggae](https://somafm.com/reggae/): Reggae, ska, and rocksteady classics and deep cuts from the San Francisco listener-supported broadcaster. [Stream](https://ice5.somafm.com/reggae-256-mp3)
...
- [BAGeL Radio](https://www.bagelradio.com/): Post-punk, psych rock, and indie from DJ Ted Leibowitz, live-hosted every Friday since 2003. [Stream](http://ais-sa3.cdnstream1.com/2606_128.aac)
...
- [Birch Street Radio](https://birchstreetradio.com/): Non-commercial mix of new music, classic rock, and indie, 60s to today. [Stream](https://streaming.live365.com/a97155)
- [Boogaloo Radio](https://www.boogalooradio.com/): Live from The Boogaloo pub in Highgate, London, rock, soul, and chat. [Stream](https://streams.radio.co/sb88c742f0/listen)
- [Cathedral 13](https://cathedral13.com/): Goth, deathrock, postpunk, and darkwave, with over 4,500 songs in rotation. [Stream](https://usa15.fastcast4u.com/proxy/tstamate?mp=/1)
- [Cosmic Fuzz](https://cosmicfuzzfm.com/): Stoner and desert rock, with a nightly psych show called Hazed and Dazed. [Stream](https://playerservices.streamtheworld.com/api/livestream-redirect/SAM04AAC335.mp3)
...
- [DARE FM](https://wdarefm.com/): New York's first alternative rock outlet, formerly WLIR, broadcasting since 1980. [Stream](http://hydra.cdnstream.com/1552_128)
- [Delicious Agony](http://www.deliciousagony.com/): Rarities and full albums from progressive rock. [Stream](http://deliciousagony.streamguys1.com/)
...
- [NTS - The Tube](https://www.nts.live/infinite-mixtapes/the-tube): Post-punk, industrial, and minimal wave from music's underground fringe. [Stream](https://stream-mixtape-geo.ntslive.net/mixtape26)
...
- [Cinemix](https://www.cinemix.us/): Orchestral movie soundtracks, regularly updated, broadcasting from France since 2003. [Stream](https://kathy.torontocast.com:1825/stream)
- [Classic FM - Video Game Music](https://www.classicfm.com/discover-music/periods-genres/video-game/): Orchestral video game soundtracks, a dedicated Classic FM stream since 2018. [Stream](https://icecast.thisisdax.com/ClassicFM-M-Gaming)
- [Classic Videogames](https://www.classic-videogames.de/radio/): Original game music and remixes from classic computers, consoles, and the demoscene. [Stream](http://195.201.9.210:1541/stream/2/)
...
- [FunkyUncleFM](https://funkyunclefm.net): Fan-made community radio for the Bomb Rush Cyberfunk game. [Stream](https://funkyunclefm.net/stream_vorbis192)
- [Gensokyo Radio](https://gensokyoradio.net): Fan-made Touhou Project music supporting independent artists and original album releases since 2011. [Stream](https://stream.gensokyoradio.net/GensokyoRadio-enhanced.m3u)
...
- [Intergalactic FM - The Dream Machine](https://intergalactic.fm/): Soundtracks and exotica from the pirate-born cult station in The Hague. [Stream](https://radio.intergalactic.fm/3A)
...
- [Liquid DooM Radio](https://liquiddoom.net/): Soundtracks from the DOOM franchise. [Stream](http://83.240.65.106:8000/doom)
...
- [NTS - Otaku](https://www.nts.live/infinite-mixtapes/otaku): Anime and video game soundtracks across console eras. [Stream](https://stream-mixtape-geo.ntslive.net/mixtape36)
- [Radio Rivendell](https://radiorivendell.com/): Fantasy soundtracks and Celtic folk for roleplaying and writing, non-commercial and online since 2001. [Stream](https://play.radiorivendell.com/radio/8000/radio.mp3)
...
- [3j Radio](https://3jradio.com/): Oldies played in English, French, and Arabic, from Beirut, Lebanon. [Stream](https://de1.streamingpulse.com/ssl/9085)
...
- [Radio Reference](https://www.radioreference.com/): Frequency database and information source for scanner and public-safety radio enthusiasts.
- [Shirley & Spinoza](https://compound-eye.org): Sound collages and field recordings. [Stream](https://s2.radio.co/sec5fa6199/listen)
...
- [System Bus Radio](https://github.com/fulldecent/system-bus-radio): Computer system activity converted into AM radio signals via hardware noise.
...
- [Wave Farm](https://wavefarm.org/): Experimental transmission art from Wave Farm's 29-acre property in New York's Hudson Valley. [Stream](https://audio.wavefarm.org/pondstation.mp3)
- [WebSDR](https://www.websdr.org): Web interface for accessing software-defined radio receivers worldwide.
- [Wide-band WebSDR](http://websdr.ewi.utwente.nl:8901/): University of Twente wide-band software-defined radio receiver.
...
- [Concertzender](https://www.concertzender.nl/themakanalen/): 170 volunteers run 22 channels spanning early music to contemporary jazz, since 1982.
- [Dinamo.FM](https://dinamo.fm/): Istanbul electronic and indie network since 2003, deliberately kept small instead of using algorithms.
...
- [Hirschmilch Radio](https://hirschmilch.de/): German electronic network since 2008, with dedicated psytrance, chillout, and techno channels.
- [Jazz Radio](https://www.jazzradio.fr/radio/webradio): French jazz and soul network with funk, blues, and lounge channels.
- [Joint Radio](https://www.jointil.com/radio/): Non-commercial since 2012, three channels covering reggae and dub, blues-rock, and psy-trance.
- [KSOL](https://ksol.live): Eight hand-picked channels ranging from jazz hop and goa trance to schranz and desi electronica.
- [Loca FM](https://www.locafm.com/live/player.html): Spanish electronic network, house, techno, and dance since 1998.
- [MRG.fm](https://www.w.mrg.fm/): Zero-revenue, listener-supported group of 16 genre channels, from decades to opera.
- [Pinguin Radio](https://pinguinradio.com/): Netherlands' top indie station since 2011, splintered from KINK FM into a dozen channels.
...
## Station Directories & Databases <a id="directories"></a>
- [Alternate Airwaves](https://alternateairwaves.com): Directory of non-commercial, community, and college stations.
- [Audiophile.fm](https://audiophile.fm/): Hi-res and lossless internet radio directory with built-in player.
- [Demoscene & Video Game Radio](https://mw.rat.bz/davgmsrl/): Michael Walden's compiled directory of about 69 demoscene and video game music streams, since 2011.
...
> [!TIP]
> Before digging for raw stream URLs manually, check the [Station Directories & Databases](#directories) section first. Many stations are already indexed on Radio Browser, FMStream, or other searchable directories.
